    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/rjsir/OneDrive/Documents/Project AIML/Attendance/Manually Attendance/'+DB_table_name+'.csv'
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                date_for_DB = datetime.datetime.fromtimestamp(
                    ts).strftime('%Y_%m_%d')
                DB_Table_name = str(Subject + "_" + date_for_DB + "_Time_" + 
                                    Hour + "_" + Minute + "_" + Second)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/rjsir/OneDrive/Documents/Project AIML/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/rjsir/OneDrive/Documents/Project AIML/Attendance/-------Check attendance-------"')
    ...
    def log_in():
        ...
        if username == 'mimansa':
            if password == 'mim1017':
                ...
                cs = 'C:/Users/rjsir/OneDrive/Documents/Project AIML/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
